salomon.heroVideo = () ->
  ...
  $('#play-overlay').bind 'click', (e) ->
    ...
    videoHeight = Math.ceil(windowHeight - 250)
    ...
    $hero.html('<div style="width:'+videoWidth+'px; height:'+videoHeight+'px; margin: 0 auto;"><div class="flex-video vimeo widescreen"><iframe src="//player.vimeo.com/video/57720773?color=00a4d1&amp;autoplay=1" width="1280" height="720" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div></div>')
